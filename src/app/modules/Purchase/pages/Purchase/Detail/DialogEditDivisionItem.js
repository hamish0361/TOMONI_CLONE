...
DialogEditDivisionItem.propTypes = {
    show: PropTypes.bool,
...
function DialogEditDivisionItem({ show, onHide, onUpdate, itemDetail, intl }) {
...
export default DialogEditDivisionItem;

...
const ContainerStatus = props => {
    ...
    const handleConfirmCutOff = () => {
        modalConfirmRef.current.open({
            title: trans("warehouse.load_up_container.cut_off.confirm.title"),
            description:  trans("warehouse.load_up_container.cut_off.confirm.description"),
        });
    }
            ...
            <div className="container-status-head card-header">
                <div className="d-flex align-items-center">
                    ...
                    {!isContainerCutOff(currentContainer) && (
                        <Button type="primary" className="ml-3" need={['containers.update']} onClick={handleConfirmCutOff}>
